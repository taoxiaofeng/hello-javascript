...
function createNotification() {
    ...
    notificationEl.style.cssText = 'width:350px;height:96px;color:#333333;font-size:14px;padding:10px;text-align:center;background: #EDF5FF;' +
        'position:fixed;right:10px;bottom:10px;z-index:9999;cursor:pointer;border: 1px solid #97C3FF;border-radius: 4px;';
    notificationEl.innerHTML = '<div style="color:#333333;font-weight:600;position:absolute;top:10px;left:10px;"><img style="vertical-align: -5px;margin-right: 10px;width: 22px;height: 22px;" src="info-fill.png">审方消息提醒：</div><div style="line-height:96px;">您有<b>' + msgCount + '</b>条新的消息，请<a style="color:#1D12E6;letter-spacing: 0.5px;text-decoration: underline;cursor: pointer;">点击查看</a>。</div><iframe id="iframe1" src="about:blank" frameBorder="0" marginHeight="0" marginWidth="0"' +
